  ...
  _createClass(Search, [{
    ...
    value: function render() {
      return React.createElement(
        "div",
        null,
        React.createElement(Filters, { filterApi: this.props.filterApi, date_ranges: this.props.date_ranges, key: "filters" }),
    ...
    value: function setLoading() {
      ...
      var FakeLoading = window.setInterval(function () {
        ...
        _this2.setState({ percent: _this2.percent, loading: true, loading_txt: "Waiting for Server to respond" });
      }, 1000);
      ...
      DataActions.fetchData(function (p) {
        ...
        if (p.percent >= 100) {
          ...
          _this2.setState({ percent: _this2.percent, loading_txt: "Loading Data" });
        }
      }, this.props.dataApi);
    }
  }, {
