...
var DataItems = (function (_React$Component) {
  ...
  function DataItems(props) {
    ...
    _get(Object.getPrototypeOf(DataItems.prototype), "constructor", this).call(this, props);
    ...
    value: function renderData() {
      if (this.state.data) {
        ...
        var items = this.state.data.map((function (k) {
          if (k) {
            return React.createElement(DataItem, { css: this.props.css, data: k, keys: this.state.visible, key: k.get("id") });
          }
        }).bind(this));
