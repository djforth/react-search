  ...
  _createClass(Search, [{
    ...
    value: function setLoading() {
      ...
      var FakeLoading = window.setInterval(function () {
        ...
        _this.setState({ percent: _this.percent, loading: true, loading_txt: _this.percent + "% loaded" });
      }, 1000);
      ...
      DataActions.fetchData(function (p) {
        ...
        if (p.percent >= 100) {
          ...
          _this.setState({ percent: _this.percent, loading_txt: _this.perecent + "% loaded" });
        }
      }, this.props.dataApi);
    }
  }, {
